...
const values = [
  {
    ...
    desc: 'Aucune progression ne vaut une blessure. On bâtit la fondation dabord.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: 'Les jeunes comprennent pourquoi ils font ce quils font. La compréhension crée la discipline.',
  },
  {
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
