...
export async function POST(req: NextRequest) {
  try {
    ...
    await resend.emails.send({
      ...
      to: CONTACT_EMAIL,
      subject: `[BASKETBALL] Nouvelle inscription — ${prenomAthlete} ${nomAthlete} — ${bloc}`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0a0e1a; color: white; padding: 40px; border-radius: 8px;">
          <div style="background: #E63946; padding: 4px 12px; display: inline-block; margin-bottom: 16px;">
            <span style="color:white; font-size:11px; letter-spacing:2px; font-weight:bold; text-transform:uppercase;">Programme Basketball Jeunesse</span>
          </div>
          <h1 style="color: #E63946; font-size: 28px; margin-bottom: 8px; letter-spacing: 2px; text-transform: uppercase;">Nouvelle Inscription</h1>
          <p style="color: rgba(255,255,255,0.5); margin-bottom: 32px;">M&A Conditioning — Basketball Jeunesse · Été 2025</p>

          <table style="width:100%; border-collapse:collapse;">
            <tr>
              <td colspan="2" style="padding:12px 0; border-bottom:1px solid rgba(230,57,70,0.3);">
                <strong style="color:#E63946; font-size:11px; letter-spacing:2px; text-transform:uppercase;">Parent</strong>
              </td>
            </tr>
            <tr>
              <td style="padding:10px 0; color:rgba(255,255,255,0.5); font-size:13px; width:40%;">Nom</td>
            ...
            <tr>
              <td colspan="2" style="padding:20px 0 12px; border-bottom:1px solid rgba(230,57,70,0.3);">
                <strong style="color:#E63946; font-size:11px; letter-spacing:2px; text-transform:uppercase;">Athlète</strong>
              </td>
            </tr>
            <tr>
              <td style="padding:10px 0; color:rgba(255,255,255,0.5); font-size:13px;">Nom</td>
            ...
            <tr>
              <td colspan="2" style="padding:20px 0 12px; border-bottom:1px solid rgba(230,57,70,0.3);">
                <strong style="color:#E63946; font-size:11px; letter-spacing:2px; text-transform:uppercase;">Programme choisi</strong>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="padding:10px 0; color:white; font-size:13px;">${semaines} semaine${Number(semaines) > 1 ? 's' : ''} · 6 sessions/semaine</td>
            </tr>
            <tr>
              <td style="padding:10px 0; color:rgba(255,255,255,0.5); font-size:13px;">Montant</td>
              <td style="padding:10px 0; color:#E63946; font-size:20px; font-weight:bold;">${montant} $</td>
            </tr>
            ${message ? `
            <tr>
              <td colspan="2" style="padding:16px 0 8px;">
                <strong style="color:#E63946; font-size:11px; letter-spacing:2px; text-transform:uppercase;">Message</strong>
              </td>
            </tr>
            <tr>
              <td colspan="2" style="padding:0 0 10px; color:rgba(255,255,255,0.7); font-size:13px;">${message}</td>
            </tr>` : ''}
          </table>

          <div style="margin-top:32px; padding:16px; border:1px solid rgba(230,57,70,0.3); background:rgba(230,57,70,0.08); border-radius:4px;">
            <p style="color:#E63946; font-size:12px; margin:0;">⚡ Action requise : Envoyer la facture de <strong>${montant}$</strong> à <strong>${courriel}</strong> dans les 7 prochains jours.</p>
          </div>
          <p style="color:rgba(255,255,255,0.2); font-size:11px; margin-top:32px; text-align:center;">M&A Conditioning · Programme Basketball · Montréal 2025</p>
        </div>
      `,
    })
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #0a0e1a; color: white; padding: 40px; border-radius: 8px;">
          ...
          <h1 style="color: #E63946; font-size: 28px; margin-bottom: 8px; letter-spacing: 2px; text-transform: uppercase;">Inscription Confirmée</h1>
          <p style="color: rgba(255,255,255,0.5); margin-bottom: 32px;">Merci ${prenomParent} ! Voici le récapitulatif pour ${prenomAthlete}.</p>
          ...
          <table style="width:100%; border-collapse:collapse;">
            ...
            <tr>
              <td style="padding:10px 0; color:rgba(255,255,255,0.5); font-size:13px;">Programme</td>
              <td style="padding:10px 0; color:white; font-size:13px;">Basketball Jeunesse · 9–12 ans</td>
            </tr>
            <tr>
              <td style="padding:10px 0; color:rgba(255,255,255,0.5); font-size:13px;">Bloc</td>
              <td style="padding:10px 0; color:white; font-size:13px;">${bloc}</td>
            ...
            <tr>
              ...
              <td style="padding:10px 0; color:white; font-size:13px;">${semaines} semaine${Number(semaines) > 1 ? 's' : ''} · 6 sessions/semaine · 2h/session</td>
            </tr>
            <tr>
              <td style="padding:10px 0; color:rgba(255,255,255,0.5); font-size:13px;">Horaires</td>
              <td style="padding:10px 0; color:white; font-size:13px;">Lun–Ven à 18h00 · Sam à 12h00</td>
            </tr>
            <tr>
          ...
          <div style="margin-top:32px; padding:20px; border:1px solid rgba(230,57,70,0.3); background:rgba(230,57,70,0.06); border-radius:4px;">
          ...
          <div style="margin-top:16px; padding:20px; border:1px solid rgba(255,255,255,0.1); border-radius:4px;">
